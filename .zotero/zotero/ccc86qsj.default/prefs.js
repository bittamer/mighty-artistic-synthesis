...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1535427434);
user_pref("app.update.lastUpdateTime.background-update-timer", 1535427674);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1535427554);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1535427314);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1535427795);
...
user_pref("extensions.zotero.sourceList.persist", "{\"L1\":true,\"P1\":false,\"C2\":true,\"C15\":true}");
...
user_pref("idle.lastDailyNotification", 1535427856);
user_pref("intl.accept_languages", "en-US, en");
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.cookie.prefsMigrated", true);
user_pref("network.predictor.cleaned-up", true);
user_pref("places.database.lastMaintenance", 1535427856);
...
user_pref("storage.vacuum.last.places.sqlite", 1532935772);
